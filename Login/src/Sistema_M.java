 ...
 * @author Ariel Brito
 */
public class Sistema_M extends javax.swing.JFrame {
    


   
    public Sistema_M() throws InstantiationException, IllegalAccessException {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Login_M ventana = new Login_M();
        ventana.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        Register_M ventana = new Register_M();
        ventana.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Sistema_M.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
